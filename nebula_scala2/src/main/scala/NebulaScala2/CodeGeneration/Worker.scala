package NebulaScala2.CodeGeneration

import akka.actor.{Actor, ActorRef, Props}
import akka.routing.{ActorRefRoutee, RemoveRoutee}
import NebulaScala2.CodeGeneration.Worker._
...
class Worker[A: ClassTag, K: ClassTag, V: ClassTag](mf: A => TraversableOnce[Worker.KeyVal[K, V]],
                                                    rf: (V, V) => V,
